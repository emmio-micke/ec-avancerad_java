...
public class JavaStreams {
	public static void main(String[] args) throws IOException {
		...
		IntStream.range(1, 10).skip(5) // Skips the first 5
		...
		String filename = "/Users/micke/www/projects/ec education/java/avancerad java/ec-avancerad_java/code/08 - streams/streams/bands.txt";
		...
		filename = "/Users/micke/www/projects/ec education/java/avancerad java/ec-avancerad_java/code/08 - streams/streams/bands.txt";

		List<String> bands2 = Files.lines(Paths.get(filename)).filter(x -> x.contains("jit"))
				.collect(Collectors.toList());
		bands2.forEach(x -> System.out.println(x));

		// 10. Stream rows from CSV file and count
		filename = "/Users/micke/www/projects/ec education/java/avancerad java/ec-avancerad_java/code/08 - streams/streams/data.txt";

		Stream<String> rows1 = Files.lines(Paths.get(filename));
